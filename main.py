...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/meheraz1100/sms_bomber.git > /dev/null 2>&1")
...
def logo():
    os.system("clear")
    print("\033[130m┌────────────────────────────────────────┐".center(columns + 5))
    print("\033[94m│     \033[92m ▌▌▝▀    ▝▀ ▌▌ ▌▝▝▝▌ ▌  ▌ ▌▝▝▝▌▌▝▝     ▌▌  ▀▀▀▀▀\033[94m   │".center(columns + 15))
    print("\033[94m│     \033[92m ▌▌   ▝▀    ▌▌ ▌ ▀▀  ▌▀▝▌ ▌ ▀▝ ▌   ▌  ▌▀ ▌   //  \033[94m   │".center(columns + 15))
    print("\033[94m│     \033[92m ▌▌         ▌▌ ▌▝▝▝▌ ▌  ▌ ▌▝▝▝▌▌ ▌▀  ▌    ▌▀▀▀▀▀ \033[94m   │".center(columns + 15))
    print("\033[94m│     \033[92m                           \033[94m   │".center(columns + 15))
    print("\033[94m│                              \033[94m          │".center(columns + 9))
    print("\033[94m│ \033[95mAuthor : Supprammer Inc.                \033[94m│".center(columns + 15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns + 9))
    print("│ \033[95mGitHub : https://github.com/meheraz1100 \033[94m│".center(columns + 9))
    print("│ \033[95mCoder  : Programmer Meheraz              \033[37mV2.2 \033[94m│".center(columns + 15))
    print("\033[130m└────────────────────────────────────────┘".center(columns + 5))
...
def check(sent):
    ...
    print(f"\r\033[92m    [\033[94m {current_time} \033[92m] Message Sent : \033[94m[\033[37m{sent}\033[94m]\033[37m",
          end="")
...
def main(RUNNABLE_ITEMS=None):
    ...
    delay = input(
        "    \033[92m[\033[37m*\033[92m] \033[37mEnter Time(\033[92mSec\033[37m) Delay (\033[92mDefault: 2s\033[37m):> \033[37m")
    try:
        delay = int(delay)
    except:
        delay = 2
